    ...
    @include('layouts.partials.category-slide')
        ...
        <div class="position-relative custom-box-shadow mb-5" >
            <div class="border-bottom border-color-1 mb-2">
                <h3 class="section-title section-title__full d-inline-block mb-0 pb-2 font-size-22" style="text-transform: uppercase">New Arrivals</h3>
            </div>
            <div class="js-slick-carousel u-slick position-static overflow-hidden u-slick-overflow-visble pb-7 pt-2 px-1"
                ...
                @foreach ($appData['latestProducts'] as $productItem)
        ...
        @include('layouts.partials.category-banner',['categoryParts'=>$categoryFirstPart])
       
        <div class="position-relative custom-box-shadow" style="margin-bottom: 50px;">
            <div class="border-bottom border-color-1 mb-2">
                <h3 class="section-title section-title__full d-inline-block mb-0 pb-2 font-size-22"> Featured Products</h3>
            </div>
            <div class="js-slick-carousel u-slick position-static overflow-hidden u-slick-overflow-visble pb-7 pt-2 px-1"
                data-pagi-classes="text-center right-0 bottom-1 left-0 u-slick__pagination u-slick__pagination--long mb-0 z-index-n1 mt-3 mt-md-0"
                data-slides-show="7"
                ...
                @foreach ($appData['featuredProducts'] as $productItem)
                <div class="js-slide products-group">
                    <div class="product-item">
                    @include('frontend.components.card-product')
                    </div>
        ...
        @include('layouts.partials.category-banner',['categoryParts'=>$categorySecondPart])



        <div class="position-relative custom-box-shadow" style="margin-bottom: 50px;">
            <div class="border-bottom border-color-1 mb-2">
                <h3 class="section-title section-title__full d-inline-block mb-0 pb-2 font-size-22"> Women Products</h3>
            </div>
            <div class="js-slick-carousel u-slick position-static overflow-hidden u-slick-overflow-visble pb-7 pt-2 px-1"
                data-pagi-classes="text-center right-0 bottom-1 left-0 u-slick__pagination u-slick__pagination--long mb-0 z-index-n1 mt-3 mt-md-0"
                data-slides-show="7"
                ...
                @foreach ($appData['womenProducts'] as $productItem)
                <div class="js-slide products-group">
                    <div class="product-item">
                    @include('frontend.components.card-product')
                    </div>
