...
@section('content')
 ...
 <div class="row">
        <div class="col-lg-12">
          <div class="card">
             <div class="card-header text-uppercase">Update Offer</div>
             <div class="card-body">
			<form action="{{route('admin.offer.update',$offer->id)}}" method="POST" enctype="multipart/form-data">
			    ...
			    <div class="form-group row">
				  ...
				  <div class="col-sm-10">
					<input type="text" name="title" value="{{$offer->title}}"  class="form-control slugFrom" placeholder="Enter title..">
					@error('title')
				...
				@enderror
				  ...
				  <div class="form-group row">
					<label for="basic-input" class="col-sm-2 col-form-label"> Icon <i class="text-danger">*</i> </label>
					<div class="col-sm-10">
					  <input type="file" name="icon" value="{{old('icon')}}"  class="form-control" placeholder="Upload icon..">
					  @error('icon')
					  <span class="text-danger" role="alert">
						  <strong>{{ $message }}</strong>
					  </span>
		...
		<div class="form-group row mx-auto mt-5">
			<div class="form-group">
				<a  class="btn btn-danger  waves-effect" href="{{ route('admin.offer.index') }}">BACK</a>
