...
<td class="text-center">
  ...
  <a title="Stock" href="{{route('admin.product.create.stock', $product['id'])}}" class="btn btn-info wave-effect" >
    <i class="fa fa-shopping-bag"></i>
    </a>

<a title="Edit" href="{{route('admin.product.edit', $product['id'])}}" class="btn btn-success wave-effect" >
